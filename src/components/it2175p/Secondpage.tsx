    ...
    return (
      ...
      <div className="flex justify-evenly items-end h-screen lg:bg-powerthatgoeasBG bg-powerthatgoeasBGMobile bg-cover bg-center overflow-hidden">
          <div className="flex flex-col justify-between xl:flex xl:flex-row xl:items-end items-center lg:flex-row w-full max-w-8xl h-full md:px-4 md:pt-4 px-4 pt-4 xl:justify-evenly">
            ...
            {/* Writing Section */}
              <section className="xl:pl-20 h-[70%] xl:h-full lg:h-full flex flex-col justify-center w-full lg:w-3/5 xl:w-2/5 px-4">
                <h1 className="lg:hidden md:text-desktop/h3 text-4xl xl:text-5xl 2xl:text-6xl mb-4 text-start lg:text-left text-white text-mobile/h4 font-[MARK_OT]">
                    Power That Goes the Extra Mile
                </h1>
                <div className=" lg:flex lg:flex-row lg:flex-wrap xl:flex xl:flex-row xl:flex-wrap xl:pb-4 2xl:flex 2xl:flex-row 2xl:flex-wrap hidden lg:pb-2 gap-4 lg:gap-2">
                    <h1 className="text-mobile/h4 xl:text-5xl 2xl:text-6xl mb-4 xl:mb-2 lg:text-left font-[MARK_OT] md:leading-[72px] md:tracking-[-0.02em] text-left text-white">
                        Power That Goes
                    </h1>
                    <h1 className="text-mobile/h4 xl:text-5xl 2xl:text-6xl mb-4 xl:mb-2 lg:text-left font-[MARK_OT] md:leading-[72px] md:tracking-[-0.02em] text-left text-white ">
                        the Extra Mile
                    ...
                    <div className="hidden ml-1 w-full md:h-20 h-[54px] flex-col justify-evenly items-start mb-10 xl:hidden lg:hidden">
                    ...
                    <div className="w-full flex flex-wrap xl:flex xl:pb-10 xl:text-desktop/h6/medium xl:font-light md:text-desktop/h5 md:font-normal md:pb-10 text-mobile/body/2 leading-[18px] tracking-[-0.02em] text-white pb-6">
                    ...
                    <p className="font-[MARK_OT] text-mobile/h7 lg:text-mobile/h6 md:leading-[31.2px] md:tracking-[-0.02em] xl:text-left text-end lg:text-center pt-4 text-white md:pb-6 md:text-[24px] xl:pt-24 xl:pl-28 ">Super Battery Mode</p>
              </section>
            ...
            {/* Phone Images Section */}
              <section className="flex flex-col justify-end items-center w-full h-full xl-max-h-[80%] xl:w-[40.4%] xl:h-[90vh] lg:w-3/4 px-4 xl:pt-4 pt-0 lg:h-auto">
                  <div className="w-full h-full max-w-[360px] max-h-[500px] lg:max-h-[100vh] lg:max-w-[60vh] flex items-center justify-center md:pt-0">
                      <img 
