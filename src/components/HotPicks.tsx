...
const HotPicks = () => {
  return (
    <>
        <div className='w-full h-screen bg-third-bg md:px-36 px-4 pt-10 overflow-hidden'>
            <div className="flex-col justify-center items-center">
                <div className='w-full h-full flex gap-4 items-center'>
                    <div className="md:w-20 md:h-20">
                        <img src="/HotStar.png" alt="" className='md:w-20 md:h-20 w-[42.42px] h-[38px]'/>
                    </div>
                ...
                <div className='w-full flex justify-between items-center gap-4 mt-6'>
                    <div className='bg-phones-bg md:w-[480px] md:h-[620px] w-[48%] h-[440px] rounded-2xl flex flex-col justify-center items-center px-4 pb-4 pt-1.5'>
                        <img src="/new.png" alt="new" className='w-[60px] h-[30px]'/>
                        <img src="/hotpickimage1.png" alt="hotpickimage1" className='w-[300px] h-[300px] mt-[15px]'/>
                        ...
                        <button className='text-white md:w-[250px] h-[50px] md:bg-price-tag md:border-gray-500 md:border-[1px] rounded-3xl flex justify-center items-center gap-2 mt-6 text-desktop/button font-[MARK_OT]'>₹10,999/- <img src="/arrow-right.png" alt="" className='w-6 h-6'/></button>
                    </div>
                    <div className='bg-phones-bg md:w-[480px] md:h-[620px] w-[48%] h-[440px] rounded-2xl flex flex-col justify-center items-center md:p-6 p-4'>
                        <img src="/hotpickimage2.png" alt="hotpickimage2" className='w-[320px] h-[100px] mt-[80px] md:hidden flex'/>
                        <img src="/hotpickimage2.png" alt="hotpickimage2" className="w-[320px] h-[220px] mt-[90px] md:flex hidden"/>
                        ...
                        <button className='text-white md:w-[250px] h-[50px] md:bg-price-tag md:border-gray-500 md:border-[1px] rounded-3xl flex justify-center items-center gap-2 mt-6  text-desktop/button font-[MARK_OT]'>₹18,999/- <img src="/arrow-right.png" alt="" className='w-6 h-6'/></button>
                    </div>
