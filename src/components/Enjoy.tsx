  ...
  return (
    <>
        <div className='w-full h-screen bg-black overflow-hidden'>
            <div className="md:mx-40 lg:mx-40 mx-8 my-16 md:flex justify-center items-center">
            <div className='w-full md:flex md:flex-col flex flex-col gap-2'>
            ...
            <div className="relative w-full h-screen">
                <img src="/ddsc.png" alt="" className="absolute md:top-0 md:left-0 top-10 w-full h-full object-cover z-0"/>
