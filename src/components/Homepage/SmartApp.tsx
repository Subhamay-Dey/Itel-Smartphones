        ...
        <div className="content flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-row sm:flex-col flex-col lg:py-10 md:py-16 md:px-10 py-6 px-0 lg:px-12 xl:px-0 2xl:px-0 w-full justify-between items-center gap-4 lg:gap-6 md:gap-4">
            <div className="">
                <div className="relative text-white lg:px-10 md:px-4 px-4 w-full">
                    <p className="absolute lg:top-6 md:top-3 top-6 md:text-desktop/h3 text-desktop/h4">Home Care</p>
                    <p className="absolute lg:top-20 md:top-16 top-20 md:text-desktop/body/1 text-desktop/body/2 flex flex-wrap md:w-9/10 lg:w-3/4 w-8/10">Enhance Home Care by automating tasks, improving efficiency and ensuring convinience</p>
                </div>
            ...
            <div className="">
                <div className="relative text-white lg:px-10 md:px-4 px-4 w-full">
                    <p className="absolute lg:top-6 md:top-3 top-6 md:text-desktop/h3 text-desktop/h4">Personal Care</p>
                    <p className="absolute lg:top-20 md:top-16 top-20 md:text-desktop/body/1 text-desktop/body/2 flex flex-wrap md:w-9/10 lg:w-3/4 w-8/10">Innovative smart hair dryers feature AI temperature control and customizable settings</p>
                </div>
