...
function SmartApp() {
  return (
    <div className="h-auto w-full bg-[#111111] lg:py-16 md:py-10 px-4 md:px-0 lg:px-0 xl:px-0">
        ...
        <div className="content flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-row sm:flex-col flex-col lg:py-10 md:py-16 md:px-10 py-6 px-0 lg:px-12 xl:px-12 2xl:px-0 w-full justify-between items-center gap-4 lg:gap-6 md:gap-4">
            <div className="">
                ...
                <img src="/homepage/Dryer.gif" alt="Dryer" className="md:max-w-full md:max-h-[620px]"/>
            ...
            <div className="">
                ...
                <img src="/homepage/VCleanr.gif" alt="VCleanr" className="md:max-w-full md:max-h-[620px]"/>
