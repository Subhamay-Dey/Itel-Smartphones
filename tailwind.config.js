		...
		animation: {
		  ...
		  keyframes: {
			...
			backgroundImage: {
				...
				'homepage-bg': "url('/homepage/FeaturePhone.gif')",
				'featurePhone': "url('/homepage/Feature+Mob.gif')",
				"whiteButton" : "url('/homepage/whitebutton.png')",
				...
				"Subtractmobile" : "url('/homepage/Subtractmobile.png')",
			},
			borderImage: {
